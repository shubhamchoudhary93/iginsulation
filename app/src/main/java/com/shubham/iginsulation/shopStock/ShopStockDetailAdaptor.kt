...
import com.shubham.iginsulation.databinding.FragmentShopStockDetailItemBinding

class ShopStockDetailAdaptor(val clickListener: ShopStockTransactionListener) :
    ListAdapter<ShopStockTransaction, ShopStockDetailAdaptor.ViewHolder>(ShopStockTransactionDiffCallback()) {
    ...
    class ViewHolder private constructor(val binding: FragmentShopStockDetailItemBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = FragmentShopStockDetailItemBinding.inflate(layoutInflater, parent, false)
